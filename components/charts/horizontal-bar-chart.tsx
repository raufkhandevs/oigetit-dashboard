        ...
        <div className="h-full flex flex-col justify-between p-2">
          {data.map((entry, index) => (
            ...
            >
              ...
              <div
                className="relative flex items-center h-full rounded-md shadow-sm z-10"
                style={{
              ...
              <div className="absolute right-2 flex items-center h-full">
                <div 
                  className={`bg-white rounded-full px-2 py-1 font-semibold text-gray-800 shadow border border-gray-200 ${
                    barHeight > 28 ? 'text-sm' : 'text-xs'
                  }`}
                >
                  {entry.value}%
