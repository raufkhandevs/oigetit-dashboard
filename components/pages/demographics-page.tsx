  ...
  return (
    <div className="space-y-4 p-6 bg-gray-100">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <ChartCard title={getChartTitle("Gender")} className="relative">
          <div className="h-[280px] p-3">
            <GenderChart data={genderData} />
          </div>
        </ChartCard>

        <ChartCard title={getChartTitle("Non Binary Gender")} className="relative">
          <div className="h-[280px] p-3">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <ChartCard title={getChartTitle("Top Occupations")} className="relative">
          <div className="h-[280px] p-3">
