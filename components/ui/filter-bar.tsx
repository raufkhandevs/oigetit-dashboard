...
export function FilterBar({
  dateRange = 'Oct 5, 2025 - Nov 5, 2025',
  ...
  const { activeSentimentFilter, setActiveSentimentFilter } =
    useSentimentFilter();
  ...
  const getSentimentFilterClass = (sentiment: SentimentFilter) => {
    const isActive =
      ...
      (sentiment === 'all' && activeSentimentFilter === 'all');
    return `cursor-pointer transition-all duration-200 rounded-full p-1 ${
      isActive
        ? 'bg-blue-500 bg-opacity-20 scale-110'
        : 'hover:scale-105 opacity-70 hover:opacity-100 hover:bg-gray-100 hover:bg-opacity-50'
    }`;
  };
  ...
  const SentimentEmojis = () => (
    <div
      className={`flex items-center gap-1 bg-white rounded-full px-2 py-1 border border-gray-200  ${
        activeSentimentFilter !== 'all' ? 'w-[164px]' : 'w-32'
      }`}
    >
      <div
      ...
      >
        <img src='/positive-emoji.png' alt='Positive' width={24} height={24} />
      </div>
      <div
      ...
      >
        <img src='/moderate-emoji.png' alt='Neutral' width={24} height={24} />
      </div>
      <div
      ...
      >
        <img src='/nagetive-emoji.png' alt='Negative' width={24} height={24} />
      </div>
      ...
      >
        <path
          d='M0.86 10.6L0.6 0.719999H2.52L2.26 10.6H0.86ZM1.54 15.2C1.16667 15.2 0.86 15.0733 0.62 14.82C0.38 14.5667 0.26 14.2533 0.26 13.88C0.26 13.5067 0.38 13.2 0.62 12.96C0.86 12.7067 1.16667 12.58 1.54 12.58C1.92667 12.58 2.24 12.7067 2.48 12.96C2.72 13.2 2.84 13.5067 2.84 13.88C2.84 14.2533 2.72 14.5667 2.48 14.82C2.24 15.0733 1.92667 15.2 1.54 15.2Z'
          fill='#FD9644'
        />
      </svg>
  ...
  return (
    <div className='bg-[#5c6bc0] text-white py-1'>
      <div className='flex flex-col lg:flex-row lg:items-center lg:justify-between'>
          ...
          <div className='flex items-center justify-center gap-2 ml-2'>
            ...
            >
              <path
                fill-rule='evenodd'
                clip-rule='evenodd'
                d='M7.40219 20.87C7.12753 20.6967 6.96102 20.3947 6.96102 20.0699L6.96115 12.657L0.625087 5.65698C0.267665 5.26086 0.0508684 4.75793 0.00814378 4.22607L8.71383e-05 4.03601V2.40002C-0.0110213 1.08826 1.04135 0.0148926 2.35311 0H18.6381C19.9499 0.0148926 21.0023 1.08826 20.9912 2.40002V3.98901C20.9915 4.62659 20.7425 5.23889 20.2972 5.69507L13.4203 12.676V17.9191C13.421 18.238 13.2613 18.536 12.9952 18.712L12.8892 18.7721L8.31625 20.9281C8.02267 21.0681 7.67733 21.0466 7.40341 20.871L7.40219 20.87ZM1.89791 2.39929V4.02527C1.89682 4.1554 1.94418 4.28125 2.03097 4.3783L8.61398 11.6473C8.77255 11.8225 8.86019 12.0503 8.86007 12.2865L8.85995 18.5684L11.52 17.3143V12.2864C11.5193 12.088 11.5813 11.8944 11.697 11.7334L11.78 11.6334L18.9439 4.35742C19.0388 4.25854 19.0912 4.12646 19.0899 3.98938V2.40039C19.1013 2.13708 18.8983 1.91394 18.6351 1.90039H2.34994C2.08761 1.91492 1.88571 2.1377 1.89694 2.40027L1.89791 2.39929Z'
                fill='white'
              />
            </svg>
            Filters
        ...
        <div className='flex lg:hidden p-2 justify-between items-center'>
          <div className='relative'>
            <Button
              ...
              className='text-white h-8 px-3 hover:bg-white/10'
            >
        ...
        <div className='w-full lg:w-auto flex flex-col lg:flex-row lg:items-center'>
          <div className='hidden lg:flex items-center justify-center p-2 mr-4'>
            <button className='flex items-center justify-center h-7 w-7 text-white bg-white rounded-full'>
              <svg
                width='12'
                height='12'
                viewBox='0 0 12 12'
              ...
              >
                <path
                  fill-rule='evenodd'
                  clip-rule='evenodd'
                  d='M10.205 11.6069L5.96301 7.3649L1.71997 11.6069C1.46912 11.8673 1.09705 11.972 0.74707 11.8805C0.397217 11.789 0.123901 11.5158 0.0324707 11.1658C-0.05896 10.8159 0.0456543 10.4439 0.306152 10.1929L4.54797 5.94991L0.30603 1.7079C0.0533447 1.45532 -0.0455322 1.08708 0.046875 0.741898C0.139282 0.396698 0.408691 0.127014 0.753784 0.0343933C1.099 -0.0582123 1.46729 0.040329 1.71997 0.292892L5.96301 4.5359L10.205 0.292908C10.5958 -0.0976868 11.2291 -0.0976257 11.6199 0.293045C12.0105 0.683716 12.0106 1.31711 11.62 1.70789L7.37695 5.9509L11.62 10.1939C12.0104 10.5847 12.01 11.2178 11.6194 11.6082C11.2286 11.9986 10.5955 11.9985 10.205 11.6079V11.6069Z'
                  fill='#6989DD'
                />
              </svg>
            </button>
          ...
          <div className='w-full flex lg:w-auto bg-white px-2 py-2 lg:px-2 lg:py-2 lg:h-20 overflow-x-auto'>
            <div className='flex items-center'>
              ...
              <div className='hidden lg:block relative'>
                <button
                  onClick={handleDatePickerToggle}
                  className='flex border-l border-[#6989DD] items-center bg-white px-2 py-2 cursor-pointer hover:bg-gray-100'
                >
                  <Calendar className='h-5 w-5 mr-2 text-black' />
                  <span className='text-black font-medium text-nowrap'>
                    {displayedDateRange}
                  </span>
                  ...
                  <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setStartDate(formatToAmerican(e.target.value))
                        }
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setEndDate(formatToAmerican(e.target.value))
                        }
                        className='w-full border border-gray-300 rounded-md px-3 py-2 text-sm text-black'
                      />
                    </div>
